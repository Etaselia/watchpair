...
The pre-commit hook runs lint, type checking, and the fast unit suite. The pre-push hook runs the production build and all integration tests. CI repeats both and verifies the production Docker image.
